...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "onlinegis2" because\n';
  ...
  $wnd.__gwt_activeModules['onlinegis2'] = {
    'moduleName' : 'onlinegis2',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/onlinegis2.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['onlinegis2'].superdevmode = true;

  var expectedSuffix = '/onlinegis2.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + onlinegis2 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:onlinegis2';
  var devModeSessionKey = '__gwtDevModeSession:onlinegis2';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/onlinegis2/onlinegis2.nocache.js';
  ...
  $wnd.__gwt_activeModules['onlinegis2'].canRedirect = true;
  $wnd.__gwt_activeModules['onlinegis2'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/onlinegis2?user.agent=' + ua + '&_callback=' + callback;
